// This file is required as phantom definitions in DefinitelyTyped are outdated
...
export interface IOpenWebPageSettings {
    operation?: string;
    encoding?: string;
    headers?: { [s: string]: string }; // An object with arbitrary keys and values of type string
    data?: string;
}
